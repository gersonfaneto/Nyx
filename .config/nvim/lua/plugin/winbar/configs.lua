...
---@class minimal.winbar.config.opts
M.opts = {
  icons = {
    kinds = {
      symbols = icons.kinds,
  ...
  symbol = {
    ---@type fun(symbol: minimal.winbar.symbol, min_width: integer?, n_clicks: integer?, button: string?, modifiers: string?)|false?
    on_click = function(symbol)
      ...
      local entries_source = nil ---@type minimal.winbar.symbol[]?
      ...
      symbol.menu = menu.winbar_menu:new({
        ...
        cursor = init_cursor,
        win_configs = win_configs,
        ---@param sym minimal.winbar.symbol
  ...
  bar = {
    ...
    hover = true,
    ---@type minimal.winbar.source[]|fun(buf: integer, win: integer): minimal.winbar.source[]
  ...
  menu = {
    ...
    ---@alias minimal.winbar.menu.win_config any|fun(menu: minimal.winbar.menu):any
    ---@type table<string, minimal.winbar.menu.win_config>
    ...
    win_configs = {
      ...
      ---@param menu minimal.winbar.menu
      col = function(menu)
...
---Set winbar options
---@param new_opts minimal.winbar.config.opts?
