...
local groupid = vim.api.nvim_create_augroup('minimal.winbar.menu', {})
local configs = require('plugin.winbar.configs')

---Lookup table for winbar menus
---@type table<integer, minimal.winbar.menu>
_G._winbar.menus = {}

---@class minimal.winbar.menu.hl_info
...
---@param opts minimal.winbar.menu.entry.opts?
---@return minimal.winbar.menu.entry
...
---@return string str
---@return minimal.winbar.menu.hl_info[] hl_info
function winbar_menu_entry:cat()
  local components_with_sep = {} ---@type minimal.winbar.symbol[]
...
---@class minimal.winbar.menu
---@field buf integer?
---@field win integer?
---@field is_opened boolean?
---@field entries minimal.winbar.menu.entry[]
...
---@field sub_menu minimal.winbar.menu? submenu, assigned when calling new() or automatically determined when a new menu opens
---@field prev_menu minimal.winbar.menu? previous menu, assigned when calling new() or automatically determined in open()
...
---@param opts minimal.winbar.menu.opts?
---@return minimal.winbar.menu
...
---Side effects: update self.clicked_at, close sub-menus
---@param symbol minimal.winbar.symbol
---@param min_width integer?
---@param n_clicks integer?
---@param button string?
---@param modifiers string?
...
function winbar_menu:make_buf()
  ...
  local max_sym_icon_len = math.max(
    0,
    unpack(
      ---@param entry minimal.winbar.menu.entry
  ...
  local hl_info = {} ---@type minimal.winbar.menu.hl_info[][]
  for _, entry in ipairs(self.entries) do
...
---Toggle the menu
---@param opts minimal.winbar.symbol.opts? menu options passed to self:open()
---@return nil
