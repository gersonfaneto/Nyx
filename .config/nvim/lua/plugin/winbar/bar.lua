...
---@class minimal.winbar.symbol.range
---@field start {line: integer, character: integer}
---@field end {line: integer, character: integer}

---@class minimal.winbar.symbol
---@field _ minimal.winbar.symbol
---@field name string
---@field icon string
...
---@field bar minimal.winbar.bar? the winbar the symbol belongs to, if the symbol is shown inside a winbar
---@field menu minimal.winbar.menu? menu associated with the winbar symbol, if the symbol is shown inside a winbar
---@field entry minimal.winbar.menu.entry? the winbar entry the symbol belongs to, if the symbol is shown inside a menu
---@field children minimal.winbar.symbol[]? children of the symbol
---@field siblings minimal.winbar.symbol[]? siblings of the symbol
...
---@field range minimal.winbar.symbol.range?
---@field on_click fun(this: minimal.winbar.symbol, min_width: integer?, n_clicks: integer?, button: string?, modifiers: string?)|false|nil force disable on_click when false
...
---@field opts minimal.winbar.symbol.opts? options passed to `winbar_symbol_t:new()` when the symbols is created
...
---@param opts minimal.winbar.symbol.opts
...
function winbar_symbol:merge(opts)
  return winbar_symbol:new(
    setmetatable(
      ...
      getmetatable(self._)
    ) --[[@as minimal.winbar.symbol.opts]]
  )
end

---@class minimal.winbar.symbol.opts
---@field _ minimal.winbar.symbol?
---@field name string?
---@field icon string?
---@field name_hl string?
...
---@class minimal.winbar.bar.opts
---@field buf integer?
---@field win integer?
---@field sources minimal.winbar.source[]?
---@field separator minimal.winbar.symbol?
---@field extends minimal.winbar.symbol?
---@field padding {left: integer, right: integer}?

---@class minimal.winbar.bar
---@field buf integer
---@field win integer
---@field sources minimal.winbar.source[]
---@field separator minimal.winbar.symbol
---@field padding {left: integer, right: integer}
---@field extends minimal.winbar.symbol
---@field components minimal.winbar.symbol[]
---@field string_cache string
---@field in_pick_mode boolean?
---@field symbol_on_hover minimal.winbar.symbol?
...
---@param opts minimal.winbar.bar.opts?
---@return minimal.winbar.bar
