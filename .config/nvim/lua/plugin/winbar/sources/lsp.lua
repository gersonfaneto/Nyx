...
local groupid = vim.api.nvim_create_augroup('minimal.winbar.sources.lsp', {})
local initialized = false

---@type table<integer, minimal.winbar.sources.lsp.document_symbol[]>
...
---@alias minimal.winbar.sources.lsp.client table

---@class minimal.winbar.sources.lsp.loc
---@field uri string
---@field range minimal.lsp.range

---@class minimal.winbar.sources.lsp.document_symbol
---@field name string
---@field kind integer
---@field tags? table
...
---@field detail? string
---@field range? minimal.lsp.range
---@field selectionRange? minimal.lsp.range
---@field children? minimal.winbar.sources.lsp.document_symbol[]

---@class minimal.winbar.sources.lsp.symbol_info
---@field name string
---@field kind integer
---@field tags? table
---@field deprecated? boolean
---@field location? minimal.winbar.sources.lsp.loc
---@field containerName? string

---@class minimal.winbar.sources.lsp.symbol_info_tree : minimal.winbar.sources.lsp.symbol_info
---@field parent? minimal.winbar.sources.lsp.symbol_info_tree
---@field children? minimal.winbar.sources.lsp.symbol_info_tree[]
---@field siblings? minimal.winbar.sources.lsp.symbol_info_tree[]

---@alias minimal.winbar.sources.lsp.symbol minimal.winbar.sources.lsp.document_symbol|minimal.winbar.sources.lsp.symbol_info
...
---@alias minimal.winbar.sources.lsp.symbol_type 'SymbolInformation'|'DocumentSymbol'

---Return type of the symbol table
---@param symbols minimal.winbar.sources.lsp.symbol[] symbol table
---@return minimal.winbar.sources.lsp.symbol_type? type symbol type
...
---@param document_symbol minimal.winbar.sources.lsp.document_symbol LSP DocumentSymbol
---@param buf integer buffer number
---@param win integer window number
---@param siblings minimal.winbar.sources.lsp.document_symbol[]? siblings of the symbol
---@param idx integer? index of the symbol in siblings
---@return minimal.winbar.symbol
...
---@param lsp_symbols minimal.winbar.sources.lsp.document_symbol[]
---@param winbar_symbols minimal.winbar.symbol[] (reference to) winbar symbols
---@param buf integer buffer number
---@param win integer window number
...
---@param symbols minimal.winbar.sources.lsp.symbol LSP symbols
---@return minimal.winbar.sources.lsp.document_symbol[]
local function unify(symbols)
  ...
  for list_idx, sym in vim.iter(symbols):enumerate():skip(1) do
    local prev = symbols[list_idx - 1] --[[@as minimal.winbar.sources.lsp.symbol_info_tree]]
...
local function update_symbols(buf, ttl)
  ...
  local _, request_id = client:request(
    ...
    function(err, symbols, _)
      ...
      ---@param s1 minimal.winbar.sources.lsp.document_symbol
      ---@param s2 minimal.winbar.sources.lsp.document_symbol
...
---@param cursor integer[] cursor position
---@return minimal.winbar.symbol[] symbols winbar symbols
