...
local groupid =
  vim.api.nvim_create_augroup('minimal.winbar.sources.markdown', {})

---@class minimal.winbar.sources.markdown.symbol
---@field name string
---@field level integer
---@field lnum integer
...
---@class minimal.winbar.sources.markdown.symbol.opts
---@field name? string
---@field level? integer
---@field lnum? integer

---Create a new markdown heading symbol object
---@param opts minimal.winbar.sources.markdown.symbol.opts?
---@return minimal.winbar.sources.markdown.symbol
...
---@class minimal.winbar.sources.markdown.symbol_parsed_list
---@field end { lnum: integer, in_codeblock: boolean }
---@field symbols minimal.winbar.sources.markdown.symbol[]
...
---@param opts minimal.winbar.sources.markdown.symbol_parsed_list?
...
---@type minimal.winbar.sources.markdown.symbol_parsed_list[]
...
---@param symbol minimal.winbar.sources.markdown.symbol markdown heading symbol
---@param symbols minimal.winbar.sources.markdown.symbol[] markdown heading symbols
...
local function convert(symbol, symbols, list_idx, buf, win)
  ...
  return bar.winbar_symbol:new(setmetatable({
    ...
    ---@param self minimal.winbar.symbol
