...
---@return (minimal.winbar.menu?)|table<integer, minimal.winbar.menu>
function M.get(opts)
  opts = opts or {}
  if opts.win then
...
---@class minimal.winbar.menu.sel.opts
...
---@field preview? fun(self: minimal.winbar.symbol, item: any, idx: integer)
---@field preview_close? fun(self: minimal.winbar.symbol, item: any, idx: integer)

---`vim.ui.select()` replacement
---@generic T string|table
---@param items T[] list of items to be selected
---@param opts minimal.winbar.menu.sel.opts
