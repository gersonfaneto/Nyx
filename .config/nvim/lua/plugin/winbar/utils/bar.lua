...
---@return (minimal.winbar.bar?)|table<integer, minimal.winbar.bar>|table<integer, table<integer, minimal.winbar.bar>>
function M.get(opts)
  opts = opts or {}
  if opts.buf then
    if opts.win then
...
---@param symbols minimal.winbar.symbol[]
