...
---@class minimal.lsp.cmd.parsed_args : minimal.cmd.parsed_args
...
---@return minimal.lsp.cmd.parsed_args parsed the parsed arguments
...
---@type table<string, minimal.lsp.cmd.completion>
...
---@alias minimal.lsp.cmd.arg_handler fun(args: minimal.lsp.cmd.parsed_args, tbl: table): ...?
---@alias minimal.lsp.cmd.params string[]
---@alias minimal.lsp.cmd.opts table
---@alias minimal.lsp.cmd.fn fun(...?): ...?
---@alias minimal.lsp.cmd.completion fun(arglead: string, cmdline: string, cursorpos: integer): string[]

---@class minimal.lsp.cmd.info
---@field arg_handler minimal.lsp.cmd.arg_handler?
---@field params minimal.lsp.cmd.params?
---@field opts minimal.lsp.cmd.opts?
---@field fn_override minimal.lsp.cmd.fn?
---@field completion minimal.lsp.cmd.completion?

local subcommands = {
  ---LSP subcommands
  ---@type table<string, minimal.lsp.cmd.info>
  lsp = {
    info = {
      opts = {
        'filter',
    ...
    auto_format = {
      ---@param args minimal.lsp.cmd.parsed_args
      ---@param tbl table information passed to the command
      ---@return minimal.lsp.cmd.parsed_args args
      ---@return table tbl
...
---@param subcommand_info_list minimal.lsp.cmd.info[] subcommands information
    ...
    if cmdline:sub(1, cursorpos):match('^%A*' .. meta .. '%s+%S*$') then
      return vim.tbl_filter(
        ...
        vim.tbl_filter(function(key)
          local args = subcommand_info_list[key] ---@type minimal.lsp.cmd.info|table|nil
          return args
...
---Setup commands
---@param meta string meta command name
---@param subcommand_info_list table<string, minimal.lsp.cmd.info> subcommands information
---@param fn_scope table|fun(name: string): function scope of corresponding functions for subcommands
---@return nil
...
local function setup_lsp_autoformat()
  ...
  vim.api.nvim_create_autocmd('BufWritePre', {
    ...
    group = vim.api.nvim_create_augroup('minimal.lsp.auto_fmt', {}),
