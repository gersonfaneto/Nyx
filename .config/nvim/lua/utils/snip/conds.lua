...
---@class minimal.snip.cond
---@operator call: boolean
---@operator unm: minimal.snip.cond
---@operator add: minimal.snip.cond
---@operator mul: minimal.snip.cond
---@operator pow: minimal.snip.cond
---@operator mod: minimal.snip.cond

---@alias minimal.snip.conds table<string, fun(...): (fun(...): boolean)>
...
---@param opts minimal.ts.get_node.opts?
---@return fun(): boolean
...
---@param opts? minimal.syn.get_group.opts
---@return fun(): boolean
