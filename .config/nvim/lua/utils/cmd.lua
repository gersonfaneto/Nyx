...
---@class minimal.cmd.parsed_args table
...
---or <optkey>
---@alias minimal.cmd.opts table
---@alias minimal.cmd.params string[]

---Get option keys / option names from opts table
---@param opts minimal.cmd.opts
---@return string[]
...
---@param params minimal.cmd.params?
---@return fun(arglead: string, cmdline: string, cursorpos: integer): string[]
