...
---@type minimal.stl.spinner[]
local spinners = {}

---@class minimal.stl.spinner
---@field opts minimal.stl.spinner.opts
---@field id integer
...
---@class minimal.stl.spinner.opts
...
---@field on_spin? fun(spinner: minimal.stl.spinner) function to execute on each update
---@field on_finish? fun(spinner: minimal.stl.spinner) function to execute on stop

---@type minimal.stl.spinner.opts
...
---@param opts minimal.stl.spinner.opts?
---@return minimal.stl.spinner
...
---@param on_spin? fun(spinner: minimal.stl.spinner)
...
---@param on_finish? fun(spinner: minimal.stl.spinner)
