...
---@type minimal.lsp.client_config
---@diagnostic disable-next-line: missing-fields
M.default_config = {
  root_markers = require('utils.fs').root_markers,
}

---@class (partial) minimal.lsp.config : vim.lsp.Config
...
---@class (partial) minimal.lsp.client_config : vim.lsp.ClientConfig
---@field requires? string[] additional executables required to start the language server
---@field buf_support? boolean whether the language server works on buffers without corresponding files
...
---the current buffer
---@param config minimal.lsp.client_config
---@param opts table?
...
---@class minimal.lsp.soft_stop.opts
---@field retry integer?
...
---@param opts minimal.lsp.soft_stop.opts?
    ...
    on_close = function()
      for buf, _ in pairs(attached_buffers) do
        ...
        vim.api.nvim_buf_call(buf, function()
          ---@cast config minimal.lsp.client_config
...
---@class minimal.lsp.range
---@field start {line: integer, character: integer}
---@field end {line: integer, character: integer}

---Check if `range1` contains `range2`
---@param range1 minimal.lsp.range 0-based range
---@param range2 minimal.lsp.range 0-based range
...
---@param range minimal.lsp.range 0-based range
