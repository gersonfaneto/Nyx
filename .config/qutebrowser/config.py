...
c.fonts.default_family = ["MonaspiceKr Nerd Font Mono"]
...
c.fonts.web.family.sans_serif = "MonaspiceKr Nerd Font Mono"
c.fonts.web.family.serif = "MonaspiceKr Nerd Font Mono"
c.fonts.web.family.standard = "MonaspiceKr Nerd Font Mono"
