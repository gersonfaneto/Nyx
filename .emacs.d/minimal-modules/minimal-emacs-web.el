...
(minimal-emacs-configure
  (with-eval-after-load 'eww
    (autoload #'minimal-simple-buffers-major-mode "minimal-simple")

    (minimal-emacs-keybind eww-mode-map
      "S" nil ; unmap `eww-list-buffers'
      "b" #'minimal-simple-buffers-major-mode ; a general version to show buffer of current mode
      "m" #'bookmark-set)
...
(minimal-emacs-configure
  (with-eval-after-load 'eww
    (require 'minimal-eww)
    (minimal-emacs-keybind eww-mode-map
      "F" #'minimal-eww-find-feed
      "o" #'minimal-eww-open-in-other-window
      "j" #'minimal-eww-jump-to-url-on-page
      "J" #'minimal-eww-visit-url-on-page)))

;;; Elfeed feed/RSS reader
(minimal-emacs-configure
  (minimal-emacs-install elfeed)
  ...
  (with-eval-after-load 'elfeed
    ...
    (minimal-emacs-keybind elfeed-search-mode-map
  ...
  (with-eval-after-load 'rcirc
    (setq rcirc-server-alist
          `(("irc.libera.chat"
             ...
             :port 6697
             :encryption tls
             :password ,(minimal-common-auth-get-field "libera" :secret))))
