(minimal-emacs-configure
  ...
  (advice-add #'window--delete :after #'minimal-common-clear-minibuffer-message))
  ...
  (setq display-buffer-alist
        `(;; no window
          ...
          ((or . ((derived-mode . occur-mode)
           ...
           (minimal-window-display-buffer-below-or-pop)
           (body-function . minimal-window-select-fit-size))
          (minimal-window-shell-or-term-p
           (display-buffer-reuse-mode-window display-buffer-at-bottom)
          ...
          ;; with `minimal-spell-ispell-display-buffer' and change the
...
(minimal-emacs-configure
  (minimal-emacs-hook (epa-info-mode-hook help-mode-hook custom-mode-hook) visual-line-mode))

(minimal-emacs-configure
  (minimal-emacs-hook (world-clock-mode-hook calendar-mode-hook) minimal-common-truncate-lines-silently))

(minimal-emacs-configure
  (minimal-emacs-keybind global-map
    ;; NOTE 2022-09-17: Also see `minimal-simple-swap-window-buffers'.
  ...
  (minimal-emacs-keybind resize-window-repeat-map
