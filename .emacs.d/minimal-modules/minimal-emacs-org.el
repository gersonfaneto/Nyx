...
(minimal-emacs-configure
  ...
  (with-eval-after-load 'org-agenda
    ...
    ;; NOTE 2021-12-07: In my `minimal-org.el' (see further below), I add
...
(minimal-emacs-configure
  ...
  (with-eval-after-load 'org
    (minimal-emacs-keybind org-mode-map
    ...
    (minimal-emacs-keybind narrow-map
      "b" #'org-narrow-to-block
      "e" #'org-narrow-to-element
      "s" #'org-narrow-to-subtree)

    (minimal-emacs-keybind ctl-x-x-map
      "i" #'minimal-org-id-headlines
      "r" #'minimal-org-id-headlines-readable
      "h" #'minimal-org-ox-html)
...
(with-eval-after-load 'org
  ...
  (when (eq minimal-emacs-load-theme-family 'modus)
    (setq org-tag-faces
    ...
    (setq org-capture-templates
          (let* ((without-time (concat ":PROPERTIES:\n"
            ...
            `(("s" "Select file and heading to add to" entry
               (function minimal-org-select-heading-in-file)
               ,(concat "* TODO %^{Title}%?\n" without-time)
               :empty-lines-after 1)
              ("t" "Task to do" entry
...
(minimal-emacs-configure
  ...
  (minimal-emacs-keybind global-map
    "C-c A" #'org-agenda
    "C-c a" (lambda ()
              "Call Org agenda with `minimal-org-custom-daily-agenda' configuration."
              (interactive)
              (org-agenda nil "A")))

  (with-eval-after-load 'org-agenda
    (minimal-emacs-keybind org-agenda-mode-map
...
;;;;; Custom agenda blocks
    ...
    (require 'minimal-org)
    (setq org-agenda-format-date #'minimal-org-agenda-format-date-aligned)

    ;; Check the variable `minimal-org-custom-daily-agenda' in minimal-org.el
    (setq org-agenda-custom-commands
          `(("A" "Daily agenda and top priority tasks"
             ,minimal-org-custom-daily-agenda
            ...
            ("P" "Plain text daily agenda and top priorities"
             ...
             ("agenda.txt"))
            ("p" "Prot Asks"
             ,minimal-org-custom-minimal-asks-agenda)))
