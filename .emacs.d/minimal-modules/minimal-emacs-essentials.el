...
(minimal-emacs-configure
  ...
  (minimal-emacs-keybind global-map
    ...
    "C-x 0" #'minimal-simple-delete-window-dwim ; overrides `delete-window'
    ;; Commands for lines
...
(minimal-emacs-configure
  (require 'minimal-register)

  (unless register-alist
    (setq register-alist (minimal-register-load)))

  (minimal-emacs-keybind global-map
    "C-, a" #'minimal-register-add-dwim
    "C-, u" #'minimal-register-use-dwim
  ...
  (minimal-register-persist-mode 1))
...
(minimal-emacs-configure
  ...
  (with-eval-after-load 'minimal-shell
