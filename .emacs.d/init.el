...
(defcustom prot-emacs-load-theme-family 'doom
  "Set of themes to load.
Valid values are the symbols `doric', `doom', `ef', `modus', and
`standard', which reference the `doric-themes', `doom-themes',
`ef-themes', `modus-themes', and `standard-themes', respectively.
...
before all other modules of my setup."
  ...
  :type '(choice :tag "Set of themes to load" :value modus
                 ...
                 (const :tag "The `doom-themes' module" doom)
