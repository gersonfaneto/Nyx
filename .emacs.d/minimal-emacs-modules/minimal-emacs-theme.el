...
(when minimal-emacs-load-theme-family
  (require
   (pcase minimal-emacs-load-theme-family
     ('modus 'minimal-emacs-modus-themes)
     ('solarized 'minimal-emacs-solarized-themes)
     ('ef 'minimal-emacs-ef-themes)
     ('doric 'minimal-emacs-doric-themes)
     ('standard 'minimal-emacs-standard-themes))))

;;;; Pulsar
;; Read the pulsar manual: <https://protesilaos.com/emacs/pulsar>.
(minimal-emacs-configure
  (minimal-emacs-install pulsar)
...
(when minimal-display-graphic-p
  (minimal-emacs-configure
    (minimal-emacs-install spacious-padding)
...
(minimal-emacs-configure
  (minimal-emacs-install rainbow-mode)
...
;;;; Theme buffet
(minimal-emacs-configure
  (minimal-emacs-install theme-buffet)
...
(minimal-emacs-configure
  (minimal-emacs-install fontaine)
...
(when minimal-display-graphic-p
  (minimal-emacs-configure
    (minimal-emacs-install show-font)
