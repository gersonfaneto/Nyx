...
(minimal-emacs-configure
  (add-hook 'minibuffer-setup-hook #'minimal-common-truncate-lines-silently)
  ...
  (unless minimal-emacs-completion-ui
    ...
    (minimal-emacs-hook
      ...
      (prot/completions-tweak-style minimal-common-truncate-lines-silently))
...
(when (and minimal-emacs-completion-extras minimal-display-graphic-p)
  (minimal-emacs-configure
