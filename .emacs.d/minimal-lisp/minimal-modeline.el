;;; minimal-modeline.el --- Code for my custom mode line -*- lexical-binding: t -*-
...
(defun minimal-modeline-major-mode-indicator ()
...
(defvar-local minimal-modeline-major-mode
    (list
     ...
     '(:eval
       (concat
        (minimal-modeline-major-mode-indicator)
        " "
        (propertize
...
(provide 'minimal-modeline)
;;; minimal-modeline.el ends here
