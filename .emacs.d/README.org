...
*** The =minimal-emacs-email.el= basic settings (including =authinfo=)
:PROPERTIES:
...
*** The =minimal-emacs-email.el= message composition and encryption settings (=message.el=)
:PROPERTIES:
...
*** The =minimal-emacs-email.el= integration with Dired for email attachments (~gnus-dired-mode~)
:PROPERTIES:
...
*** The =minimal-emacs-email.el= settings for ~sendmail~ (SMTP)
:PROPERTIES:
...
*** The =minimal-emacs-email.el= loading of the email client and call to ~provide~
:PROPERTIES:
...
*** The =minimal-emacs-email.el= submodule for ~notmuch~ (=minimal-emacs-notmuch.el=)
:PROPERTIES:
...
**** The =minimal-emacs-notmuch.el= section about the account settings
:PROPERTIES:
...
**** The =minimal-emacs-notmuch.el= section about the general user interface
:PROPERTIES:
...
**** The =minimal-emacs-notmuch.el= section about the presentation of search buffers
:PROPERTIES:
...
**** The =minimal-emacs-notmuch.el= section about tag settings
:PROPERTIES:
...
**** The =minimal-emacs-notmuch.el= section about email composition settings
:PROPERTIES:
...
**** The =minimal-emacs-notmuch.el= section about reading messages
:PROPERTIES:
...
**** The =minimal-emacs-notmuch.el= section about hooks and key bindings
:PROPERTIES:
...
**** The =minimal-emacs-notmuch.el= custom extensions (per =minimal-notmuch.el=)
:PROPERTIES:
...
**** The =minimal-emacs-notmuch.el= glue code for ~org-capture~ (=ol-notmuch.el=)
:PROPERTIES:
...
**** The =minimal-emacs-notmuch.el= section about the ~notmuch-indicator~
:PROPERTIES:
...
**** The =minimal-emacs-notmuch.el= call to ~provide~
:PROPERTIES:
...
*** The deprecated =minimal-emacs-mail.el= submodule for ~mu4e~ (=minimal-emacs-mu4e.el=)
:PROPERTIES:
...
*** The deprecated =minimal-emacs-mail.el= submodule for Gnus (=minimal-emacs-gnus.el=)
:PROPERTIES:
