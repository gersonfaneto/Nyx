...
*** COMMENT The =minimal-emacs-essentials.el= section about =minimal-simple.el= (custom basic commands)
:PROPERTIES:
...
** The =minimal-emacs-email.el= module
:PROPERTIES:
