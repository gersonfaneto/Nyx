...
**** The =prot-emacs-solarized-themes.el= module
:PROPERTIES:
:CUSTOM_ID: h:b7923dc9-5e93-4646-be41-396c92253996
:END:

#+begin_src emacs-lisp :tangle "prot-emacs-modules/prot-emacs-solarized-themes.el"
(prot-emacs-configure
  (prot-emacs-install solarized-theme)
  (load-theme 'solarized-dark t))

(provide 'prot-emacs-solarized-themes)
#+end_src
...
+ Git repositories:
  - GitHub: <https://github.com/protesilaos/mandouran>
...
(prot-emacs-configure
  (prot-emacs-install mandoura :url "https://github.com/protesilaos/mandoura.git")
  (with-eval-after-load 'dired
    (require 'mandoura)
    (prot-emacs-keybind global-map
